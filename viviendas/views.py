...
#                 viviendas = viviendas.filter(ubicacion=ubicacion)
#
...
#                 viviendas = viviendas.filter(superficie__gte=supmin)
#
#             if request.POST['supmax']:
#                 supmax = request.POST['supmax']
#                 viviendas = viviendas.filter(superficie__lte=supmax)
#
#             return render(request, "viviendas/viviendas.html", {'viviendas': viviendas, 'form': busqueda_form})
#     else:
